...
import { Eye, EyeOff, Zap, Check, UserPlus } from 'lucide-react';
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className={`flex h-[18px] w-[18px] items-center justify-center rounded border ${rememberMe ? 'border-accent-blue bg-accent-blue' : 'border-[#CCCCCC] bg-[#F5F5F5]'}`}
              >
            ...
            {!isRegister && (
              <button
                type="button"
                onClick={() => signIn('github', { callbackUrl: '/d' })}
                className="flex h-12 w-full items-center justify-center rounded-xl border border-[#E8E8E8] bg-[#F5F5F5] text-[15px] font-semibold text-[#333333]"
            ...
            <button
              ...
              className="flex h-12 w-full items-center justify-center rounded-xl border border-[#E8E8E8] bg-[#F5F5F5] text-[15px] font-semibold text-[#333333] gap-2"
              style={{ fontFamily: 'Plus Jakarta Sans' }}
            >
